...
- **Interactive Resume Builder:** Step-by-step interactive resume creator with AI summary options, bullet rephrasing, unified Core Competency skills, standardized Education date formatting (`Aug 2026`, `Dec 2024`), and structured certificate management (Certificate Name, Issuing Institution like Huawei, Cisco, freeCodeCamp, AI CERTs, Samsung Engineering, and Date Received / Expiry).
