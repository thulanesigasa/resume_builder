...
- **Interactive Resume Builder:** Step-by-step interactive resume creator with AI summary options, bullet rephrasing, unified Core Competency skills, standardized Education date formatting (`Aug 2026`, `Dec 2024`), structured certificate management, and seamless pre-filling from saved archives when clicking "Open in Editor".
