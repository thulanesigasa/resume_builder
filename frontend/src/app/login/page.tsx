      ...
      <div className="w-full max-w-md">
        ...
        <div className="glass-panel p-8 rounded-2xl w-full">
          ...
          <button
            ...
            disabled={loading}
            className="w-full flex items-center justify-center gap-3 px-4 py-2.5 border border-brand-navy/20 hover:border-brand-indigo/30 bg-white hover:bg-slate-50 text-brand-deep font-semibold text-sm rounded-xl transition-all shadow-sm mb-6 cursor-pointer disabled:opacity-50"
          >
