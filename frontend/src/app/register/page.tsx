              ...
              <form onSubmit={(e) => { e.preventDefault(); if (step < 3) handleNextStep(); else handleRegister(e); }} className="space-y-5">
                {step === 1 && (
                  <div className="space-y-5">
                    ...
                    <div className="w-full flex items-center justify-between gap-3 px-4 py-2.5 border border-brand-navy/10 bg-brand-navy/[0.02] text-brand-navy/40 text-sm rounded-xl cursor-not-allowed select-none">
