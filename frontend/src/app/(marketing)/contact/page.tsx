...
export default function ContactPage() {
  ...
  return (
    <div className="max-w-5xl mx-auto px-6 grid grid-cols-1 md:grid-cols-2 gap-12 items-center animate-in fade-in slide-in-from-bottom-8 duration-700">
      <div className="space-y-12">
        ...
        <div className="space-y-8 animate-in fade-in slide-in-from-left-8 duration-700 delay-200 fill-mode-both">
          <div className="relative group">
            ...
            <a href="mailto:support@rbptech.com" className="text-sm text-brand-navy/80 hover:text-brand-indigo transition-colors inline-block mt-1">support@rbptech.com</a>
          </div>
          ...
          <div className="relative group">
            ...
            <div className="text-sm text-brand-navy/80 mt-1">Available Mon-Fri, 9am - 5pm EST</div>
          </div>
        </div>
      </div>
