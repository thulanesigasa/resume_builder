  ...
  return (
    <div className="max-w-4xl mx-auto px-6 space-y-24 animate-in fade-in slide-in-from-bottom-8 duration-700">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div 
          className="glass-panel p-10 rounded-2xl relative overflow-hidden group border-t-4 border-t-brand-indigo/20 hover:-translate-y-2 focus:-translate-y-2 focus:border-t-brand-indigo/40 transition-all duration-500 animate-in fade-in slide-in-from-bottom-12 duration-700 delay-100 fill-mode-both cursor-pointer focus:outline-none"
          tabIndex={0}
        >
          <div className="absolute top-4 right-4 text-4xl font-black text-brand-navy/5 select-none group-hover:text-brand-indigo/10 group-focus:text-brand-indigo/10 transition-colors">01</div>
          <div className="relative z-10">
            <h3 className="text-xl font-bold text-brand-deep transition-transform duration-500 group-hover:-translate-y-1 group-focus:-translate-y-1">Precision Tuning</h3>
        ...
        <div 
          ...
          tabIndex={0}
        >
          <div className="absolute top-4 right-4 text-4xl font-black text-brand-navy/5 select-none group-hover:text-brand-indigo/10 group-focus:text-brand-indigo/10 transition-colors">02</div>
          <div className="relative z-10">
            <h3 className="text-xl font-bold text-brand-deep transition-transform duration-500 group-hover:-translate-y-1 group-focus:-translate-y-1">Parser Safe</h3>
            <div className="grid grid-rows-[0fr] group-hover:grid-rows-[1fr] group-focus:grid-rows-[1fr] transition-all duration-500 ease-in-out opacity-0 group-hover:opacity-100 group-focus:opacity-100">
              <div className="overflow-hidden">
        ...
        <div 
          className="glass-panel p-10 rounded-2xl relative overflow-hidden group border-t-4 border-t-brand-indigo/20 hover:-translate-y-2 focus:-translate-y-2 focus:border-t-brand-indigo/40 transition-all duration-500 animate-in fade-in slide-in-from-bottom-12 duration-700 delay-300 fill-mode-both cursor-pointer focus:outline-none"
          tabIndex={0}
        >
          <div className="absolute top-4 right-4 text-4xl font-black text-brand-navy/5 select-none group-hover:text-brand-indigo/10 group-focus:text-brand-indigo/10 transition-colors">03</div>
          <div className="relative z-10">
            <h3 className="text-xl font-bold text-brand-deep transition-transform duration-500 group-hover:-translate-y-1 group-focus:-translate-y-1">Candidate First</h3>
            <div className="grid grid-rows-[0fr] group-hover:grid-rows-[1fr] group-focus:grid-rows-[1fr] transition-all duration-500 ease-in-out opacity-0 group-hover:opacity-100 group-focus:opacity-100">
              <div className="overflow-hidden">
