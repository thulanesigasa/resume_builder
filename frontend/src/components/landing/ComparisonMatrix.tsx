  ...
  return (
    <section className="bg-indigo-950 text-white py-16 md:py-24 border-b border-indigo-900">
      <div className="max-w-6xl mx-auto px-4 md:px-6 space-y-12">
        ...
        {/* Plan Cards Grid (Pure Purple & White) */}
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto items-stretch">
          ...
          <article className="bg-white text-slate-900 rounded-2xl overflow-hidden shadow-xl flex flex-col justify-between border border-slate-200">
            <div>
              ...
              <div className="p-6 md:p-8 text-center space-y-2 border-b border-slate-100">
                <h3 className="text-4xl font-black text-indigo-950">Free</h3>
          ...
          <article className="bg-white text-slate-900 rounded-2xl overflow-hidden shadow-2xl flex flex-col justify-between border-2 border-indigo-700 relative">
            
            <div className="absolute top-3 right-3 bg-indigo-950 text-white text-[10px] font-black uppercase px-2.5 py-0.5 rounded">
              Best Value
            </div>

            <div>
              <header className="bg-indigo-700 text-white text-center py-2.5 text-xs font-black uppercase tracking-widest">
                PREMIUM PLAN
              </header>

              <div className="p-6 md:p-8 text-center space-y-2 border-b border-slate-100">
                <div className="flex items-baseline justify-center gap-1">
                  <span className="text-4xl font-black text-indigo-950">R15</span>
            ...
            <footer className="p-6 border-t border-slate-100">
              <button
                onClick={() => router.push("/register")}
                className="w-full py-3.5 bg-indigo-700 hover:bg-indigo-800 text-white font-bold text-xs rounded-xl transition-all cursor-pointer shadow-sm"
              >
                Get Premium CV
              </button>
            </footer>
